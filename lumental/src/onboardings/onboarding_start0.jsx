...
export default function OnboardingStart() {
  ...
  return (
    ...
    borderRight: '1px solid rgba(0,0,0,0.08)', background: 'linear-gradient(135deg, black 0%, #011635 43%, #468AF0 86%)', height: '100%' }}>
        ...
        <div><img className='startlogo' src={startlogo} alt="시작화면 로고" style={{height: 80, width: 240, boxSizing: 'content-box', marginTop: 50, marginLeft: 15}}  /></div>
        <div style={{display: 'flex', alignItems: 'center', justifyContent: 'center'}}><img src={onlyLlogo} style={{width: 150, height: 150, boxSizing: 'content-box', marginTop: 150, marginBottom: 150}}></img></div>
